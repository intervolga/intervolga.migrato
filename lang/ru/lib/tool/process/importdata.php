<?
$MESS['INTERVOLGA_MIGRATO.STEP_INIT'] = 'Инициализация импорта из XML в БД';
$MESS['INTERVOLGA_MIGRATO.STEP_ITERATE_IMPORT'] = 'Импорт данных с зависимостями (итерация #i#)';
$MESS['INTERVOLGA_MIGRATO.STEP_ITERATE_IMPORT_RECORDS'] = 'Выбрано #i# зап.';
