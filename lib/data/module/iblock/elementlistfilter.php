...
class ElementListFilter extends BaseData
{
	...
	/**
	 * @param string $filterId - b_filter table field
	 * @return string
	 */
	...
	/**
	 * @param Record $record
	 * @param string $fields - FIELDS field
	 */
	...
	/**
	 * @param Record $record
	 * @param array $fields - field FIELDS with properties xmlId
	 * @param array $propertyIds
	 * @return array - converted FIELDS array with properties enum xmlId
	 */
